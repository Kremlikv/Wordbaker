...
--
-- Table structure for table `kremlik_ibsa_bednar_20250609`
--

DROP TABLE IF EXISTS `kremlik_ibsa_bednar_20250609`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kremlik_ibsa_bednar_20250609` (
  `Czech` varchar(255) NOT NULL,
  `English` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `kremlik_ibsa_bednar_20250609`
--

LOCK TABLES `kremlik_ibsa_bednar_20250609` WRITE;
/*!40000 ALTER TABLE `kremlik_ibsa_bednar_20250609` DISABLE KEYS */;
INSERT INTO `kremlik_ibsa_bednar_20250609` VALUES ('jako obvykle','as usual'),('to závisí','it depends'),('hledal jsem klíče a našel je','I looked for keys and then I found them'),('přišel jsem, abych ti pomohl','I came to help you'),('je snadné to udělat','it is easy to do'),('židle je na sezení','a chair is for sitting'),('rád bych se napil','I would like to drink.'),('potřebuji to opravit','I need to repair it');
/*!40000 ALTER TABLE `kremlik_ibsa_bednar_20250609` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `kremlik_prestobednar_20250609`
--

DROP TABLE IF EXISTS `kremlik_prestobednar_20250609`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kremlik_prestobednar_20250609` (
  `Czech` varchar(255) NOT NULL,
  `English` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `kremlik_prestobednar_20250609`
--

LOCK TABLES `kremlik_prestobednar_20250609` WRITE;
/*!40000 ALTER TABLE `kremlik_prestobednar_20250609` DISABLE KEYS */;
INSERT INTO `kremlik_prestobednar_20250609` VALUES ('jako obvykle','as usual'),('to závisí','it depends'),('hledal jsem klíče a našel je','I looked for keys and then I found them'),('přišel jsem, abych ti pomohl','I came to help you'),('je snadné to udělat','it is easy to do'),('židle je na sezení','a chair is for sitting'),('rád bych se napil','I would like to drink.'),('potřebuji to opravit','I need to repair it');
/*!40000 ALTER TABLE `kremlik_prestobednar_20250609` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-08-25 11:56:37

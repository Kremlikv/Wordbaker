...
.file-panel { flex:1; background:#ddd; padding:0; max-height:66vh; overflow-y:auto; }
.file-item { padding:8px 10px; cursor:pointer; border:1px solid #fff; text-align:left; background:#ddd; }
.file-item:hover { background:#ccc; }
@media (max-width:768px){ .two-column{flex-direction:column} .folder-panel,.file-panel{width:100%; max-height:40vh}}
...
(function(){
  ...
  // Share → copy to shared_<folder>_*
  ...
  // Copy (same user) → ask destination folder only
